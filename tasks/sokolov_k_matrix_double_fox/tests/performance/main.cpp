...
const auto kAllPerfTasks =
    ppc::util::MakeAllPerfTasks<InType, SokolovKMatrixDoubleFoxOMP, SokolovKMatrixDoubleFoxSEQ,
                                SokolovKMatrixDoubleFoxTBB>(PPC_SETTINGS_sokolov_k_matrix_double_fox);
